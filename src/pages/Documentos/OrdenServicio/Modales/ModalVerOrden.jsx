  ...
  const renderSeccionOrden = () => (
    <div className="meo-form-grid">
      ...
      <CampoVisualizacion
        ...
        valor={
          orden.fecha_orden_servicio
            ? formatearFecha(orden.fecha_orden_servicio)
            : "No disponible"
        }
      />
  ...
  const renderSeccionServicio = () => (
    <div className="meo-form-grid">
      ...
      <CampoVisualizacion
        ...
        valor={
          orden.fecha_inicio_servicio
            ? formatearFecha(orden.fecha_inicio_servicio)
            : "No disponible"
        }
      />
      <CampoVisualizacion
      ...
      <CampoVisualizacion
        ...
        valor={
          orden.fecha_final_servicio
            ? formatearFecha(orden.fecha_final_servicio)
            : "No disponible"
        }
      />
      <CampoVisualizacion
