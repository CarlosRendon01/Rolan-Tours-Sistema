 ...
 * @param {Object} factura - Datos de la factura a generar
...
export const imprimirFactura = (factura, empresa = {}) => {
  try {
    ...
    ventanaImpresion.document.write(`
      ...
      <body>
        ${generarHTMLFactura(factura, empresa)}
...
/**
 * Genera el HTML de la factura con estilos inline
...
const generarHTMLFactura = (factura, empresaParam = {}) => {
  ...
  const tasaIVA = factura.tasaIVA || 0.16;
      ...
      <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 25px; padding-bottom: 20px; border-bottom: 3px solid #4338ca;">
        ...
        <div style="text-align: right; min-width: 250px;">
          ...
          <div style="margin-bottom: 12px;">
            ...
            <p style="margin: 3px 0 0 0; font-size: 20px; font-weight: 700; color: #4338ca;">${numeroFactura}</p>
          </div>
          <div style="font-size: 11px; color: #6b7280;">
            <p style="margin: 2px 0;"><strong>Fecha Emisión:</strong> ${fechaActual}</p>
            <p style="margin: 2px 0;"><strong>Fecha Certificación:</strong> ${fechaActual}</p>
          </div>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1fr auto; gap: 20px; margin-top: 20px; padding-top: 20px; border-top: 2px solid #e5e7eb;">
        <div>
          <div style="margin-bottom: 12px;">
            ...
            <p style="font-size: 12px; color: #1f2937; margin: 0; font-weight: 500;">PPD - Pago en Parcialidades o Diferido</p>
          </div>
          <div style="margin-bottom: 12px;">
