...
const ModalReactivarPago = ({ estaAbierto, alCerrar, pago, alReactivar }) => {
  ...
  const manejarReactivar = async () => {
    ...
    try {
      ...
      if (typeof window !== "undefined" && window.Swal) {
        ...
        alert(
          "Ocurrió un error al reactivar el pago. Por favor, intente nuevamente."
        );
      }
    }
  };
  ...
  return (
    <div className="modal-reactivar-overlay" onClick={manejarCancelar}>
      <div
        className="modal-reactivar-contenido"
      ...
      >
        ...
        <p className="modal-reactivar-descripcion">
          El pago volverá a estar activo y visible para todos los usuarios del
          sistema.
        </p>
        ...
        <div className="modal-reactivar-mensaje-exito">
          <CheckCircle size={20} />
          <span>
            Este pago volverá a estar{" "}
            <strong>visible para todos los usuarios</strong> del sistema.
          </span>
        </div>
