...
const ModalAgregarGuia = ({ onGuardar, onCerrar }) => {
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      ...
      `,
        ...
        customClass: {
          popup: 'swal-guia-popup-custom',
          title: 'swal-guia-title-custom',
          htmlContainer: 'swal-guia-html-custom',
    ...
    <div className="modal-guia-form-grid">
      <div className="modal-guia-form-group">
        <label htmlFor="nombre">
          Nombre <span className="modal-guia-required">*</span>
        </label>
        <input
          type="text"
          id="nombre"
          ...
          className={errores.nombre ? 'modal-guia-input-error' : ''}
          placeholder="Ej: Juan"
        />
      ...
      <div className="modal-guia-form-group">
        <label htmlFor="apellido_paterno">
          Apellido Paterno <span className="modal-guia-required">*</span>
        </label>
        <input
          type="text"
          id="apellido_paterno"
          ...
          onChange={handleChange}
          className={errores.apellido_paterno ? 'modal-guia-input-error' : ''}
      ...
      <div className="modal-guia-form-group">
        <label htmlFor="apellido_materno">
          Apellido Materno <span className="modal-guia-required">*</span>
        </label>
        <input
          type="text"
          id="apellido_materno"
          ...
          onChange={handleChange}
          className={errores.apellido_materno ? 'modal-guia-input-error' : ''}
      ...
      <div className="modal-guia-form-group">
        ...
        <input
          ...
          onChange={handleChange}
          className={errores.telefono ? 'modal-guia-input-error' : ''}
      ...
      <div className="modal-guia-form-group">
        <label htmlFor="email">
          Email <span className="modal-guia-required">*</span>
        </label>
        <input
          type="email"
          id="email"
          ...
          onChange={handleChange}
          className={errores.email ? 'modal-guia-input-error' : ''}
      ...
      <div className="modal-guia-form-group">
        <label htmlFor="ciudad">
          Ciudad <span className="modal-guia-required">*</span>
        </label>
        <input
          type="text"
          id="ciudad"
          ...
          onChange={handleChange}
          className={errores.ciudad ? 'modal-guia-input-error' : ''}
      ...
      <div className="modal-guia-form-group">
        <label htmlFor="estado">
          Estado <span className="modal-guia-required">*</span>
        </label>
        <input
          type="text"
          id="estado"
          ...
          onChange={handleChange}
          className={errores.estado ? 'modal-guia-input-error' : ''}
          placeholder="Oaxaca"
        />
      ...
      <div className="modal-guia-form-group">
        <label htmlFor="contacto_emergencia">
          Contacto de Emergencia <span className="modal-guia-required">*</span>
        </label>
        <input
          type="text"
          ...
          onChange={handleChange}
          className={errores.contacto_emergencia ? 'modal-guia-input-error' : ''}
      ...
      <div className="modal-guia-form-group">
        <label htmlFor="telefono_emergencia">
          Teléfono de Emergencia <span className="modal-guia-required">*</span>
        </label>
        <input
          type="tel"
          ...
          onChange={handleChange}
          className={errores.telefono_emergencia ? 'modal-guia-input-error' : ''}
          placeholder="9511234567"
          maxLength="10"
        />
  ...
  const renderSeccionDocumentos = () => (
    <div className="modal-guia-form-grid-documentos">
      <div className="modal-guia-form-group-file">
        ...
        />
        {formData.foto_guia && (
          <span className="modal-guia-file-name">{formData.foto_guia.name}</span>
        )}
      </div>
      ...
      <div className="modal-guia-form-group-file">
        ...
        />
        {formData.foto_ine && (
          <span className="modal-guia-file-name">{formData.foto_ine.name}</span>
        )}
      </div>
      ...
      <div className="modal-guia-form-group-file">
        ...
        {formData.foto_licencia && (
          <span className="modal-guia-file-name">{formData.foto_licencia.name}</span>
        )}
      </div>
    ...
    <div className="modal-guia-overlay" onClick={onCerrar}>
      <div className="modal-guia-contenido modal-guia-xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-guia-footer">
          ...
          <div className="modal-guia-botones-derecha">
            <button
              type="button"
              className={`modal-guia-btn-guardar ${guardando ? 'loading' : ''}`}
              disabled={guardando}
