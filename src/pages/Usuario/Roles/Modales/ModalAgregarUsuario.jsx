...
const ModalAgregarUsuarios = ({ onGuardar, onCerrar, roles = [] }) => {
  ...
  const mostrarNotificacionExito = (nombreCompleto) => {
    if (typeof window !== "undefined" && window.Swal) {
      window.Swal.fire({
        ...
        text: `El usuario "${nombreCompleto}" ha sido creado correctamente`,
        icon: "success",
        iconHtml: "✓",
        iconColor: "#28a745",
      ...
      alert(`¡Usuario ${nombreCompleto} agregado exitosamente!`);
    }
  };
  ...
  const handleSubmit = useCallback(async () => {
    ...
    console.log("✅ Validación exitosa, guardando usuario...");
    setGuardando(true);
    ...
    try {
      ...
      console.log("✅ Usuario guardado, mostrando notificación...");
      ...
      if (typeof window !== "undefined" && window.Swal) {
        window.Swal.fire({
          title: "Error",
          text: "Hubo un problema al crear el usuario. Por favor, intenta nuevamente.",
          icon: "error",
        ...
        alert(
          "Hubo un problema al guardar el usuario. Por favor, inténtalo de nuevo."
        );
      }
    }
  ...
  const MensajeError = ({ nombreCampo }) => {
    ...
    return <span className="modal-usuario-error-mensaje">{error}</span>;
  };

  return (
    <div className="modal-usuario-overlay" onClick={onCerrar}>
      <div
        className="modal-usuario-contenido"
      ...
      >
        ...
        <div className="modal-usuario-header">
          ...
          <button
            className="modal-usuario-btn-cerrar"
            onClick={onCerrar}
            type="button"
          >
            <X size={24} />
        ...
        {/* Formulario */}
        <div className="modal-usuario-form">
          <div className="modal-usuario-form-grid">
            {/* Nombre */}
            <div className="modal-usuario-form-group">
              <label htmlFor="nombre">
                Nombre <span className="modal-usuario-required">*</span>
              </label>
              <input
                type="text"
                id="nombre"
                ...
                className={errores.nombre ? "modal-usuario-input-error" : ""}
                placeholder="Juan"
              />
            ...
            <div className="modal-usuario-form-group">
              <label htmlFor="apellido_paterno">
                Apellido Paterno{" "}
                <span className="modal-usuario-required">*</span>
              </label>
              <input
                type="text"
                id="apellido_paterno"
                ...
                onChange={handleChange}
                className={
                  errores.apellido_paterno ? "modal-usuario-input-error" : ""
                }
                placeholder="Pérez"
              />
            ...
            <div className="modal-usuario-form-group">
              <label htmlFor="rol_id">
                Rol <span className="modal-usuario-required">*</span>
              </label>
              <select
                id="rol_id"
                name="rol_id"
                ...
                onChange={handleChange}
                className={errores.rol_id ? "modal-usuario-input-error" : ""}
              >
            ...
            <div className="modal-usuario-form-group">
              ...
              <input
                ...
                onChange={handleChange}
                className={errores.email ? "modal-usuario-input-error" : ""}
            ...
            <div className="modal-usuario-form-group">
              ...
              <input
                ...
                onChange={handleChange}
                className={errores.telefono ? "modal-usuario-input-error" : ""}
            ...
            {/* Foto de Perfil */}
            <div className="modal-usuario-form-group modal-usuario-form-group-full">
              <label htmlFor="foto">
                <Camera size={20} />
                Foto de Perfil
              </label>
              <div className="modal-usuario-foto-container">
                {vistaPrevia && (
                  <div className="modal-usuario-vista-previa">
                ...
                <input
                  ...
                  accept="image/*"
                  className="modal-usuario-input-file"
                />
                {formData.foto && (
                  <span className="modal-usuario-file-name">
                    {formData.foto.name}
                  </span>
                )}
              </div>
              <span className="modal-usuario-hint">
        ...
        <div className="modal-usuario-footer">
          <div className="modal-usuario-botones-izquierda">
            <button
              type="button"
              className="modal-usuario-btn-cancelar"
              onClick={onCerrar}
            >
              Cancelar
            </button>
          </div>
          <div className="modal-usuario-botones-derecha">
            <button
              type="button"
              className={`modal-usuario-btn-guardar ${
                guardando ? "loading" : ""
              }`}
              disabled={guardando}
