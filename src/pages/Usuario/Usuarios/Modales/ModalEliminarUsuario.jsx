...
const ModalEliminarUsuario = ({ usuario, alConfirmar }) => {
  ...
  return (
    <div className="modal-overlay-simple" onClick={manejarCancelar}>
      ...
      >
        ...
        <h3 className="modal-title-simple">¿Eliminar Usuario?</h3>

        <p className="modal-message-simple">
          Esta acción eliminará al usuario <strong>{nombreCompleto}</strong> del
          sistema.
        </p>
